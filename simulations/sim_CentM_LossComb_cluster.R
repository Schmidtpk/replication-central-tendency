...
FC_combination_tbl <- FC_combination_tbl_full[c(1:3,7:10),]
...
# Artificially transform the theta-combination-values to their real theta1 and theta2 values
hlp <- fcrat::test_convex(x=GDP$FC.first, y=GDP$Obs.first, instruments=list(c("1","X")), number_values = 13)
...
saveRDS(df_ConvexComb, 
        file = "./simulations/data_sim/df_CentM_Full_LossComb_20240328.rds")
...
saveRDS(df_ConvexComb_plot, 
        file = "./simulations/data_sim/df_CentM_InclRates_LossComb_20240328.rds")
